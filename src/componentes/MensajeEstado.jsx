...
export function MensajeEstado({ tipo = 'info', children }) {
  // Si no hay mensaje, no se crea una alerta vacia en la pantalla.
  if (!children) return null

  return (
    // La clase cambia segun el tipo: info, success, warning o danger.
    <div className={`alert alert-${tipo} d-flex align-items-center gap-2`} role="alert">
      <i className="bi bi-info-circle"></i>
      {/* pre-line permite mostrar saltos de linea en mensajes de alertas. */}
